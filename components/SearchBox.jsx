...
const SearchBox = ({ onEventSelect }) => {
    ...
    const handleSearch = () => {
        ...
        if (query.trim() && onEventSelect) {
            onEventSelect({ searchQuery: query.trim() });
        }
    };
        ...
        <div className="relative" ref={dropdownRef}>
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full pl-12 pr-12 py-3 text-sm border border-slate-200 rounded-lg shadow-xs focus:outline-none focus:ring-1 focus:ring-gray-300 focus:border-transparent transition-all duration-200 bg-white"
                />
